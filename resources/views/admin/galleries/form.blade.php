...
<form action="{{ isset($row) ? route('admin.galleries.update', $row->id) : route('admin.galleries.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    @if(isset($row))
        @method('PUT')
    @endif
    ...
    <div class="form-layout-grid">
        ...
        <div class="form-card-sidebar">
            ...
            <div class="form-actions">
                ...
                <a href="{{ route('admin.galleries.index') }}" class="btn-cancel">Batalkan</a>
            </div>
        </div>

    ...
    <div class="crud-card-full">
        <div class="table-header">
            ...
            <div style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
                <a href="{{ route('admin.categories.index', ['type' => 'albums']) }}" class="btn btn-outline-secondary">
                    <i class="fa-solid fa-images me-1"></i> Kategori
                </a>
            ...
            <tbody>
                @forelse($albums as $album)
                    <tr class="data-row">
                        ...
                        <td style="text-align: center;">
                            @if ($album->cover_photo)
                                <div style="display: flex; flex-direction: column; align-items: center; gap: 4px;">
                                    <img src="{{ asset($album->cover_photo) }}" alt="Cover"
                                        style="width: 48px; height: 48px; object-fit: cover; border-radius: 6px; border: 1px solid var(--border-color, #e2e8f0);">
                                    <span
                                        style="font-size: 11px; font-weight: 600; color: var(--text-muted, #64748b);">{{ $album->photos_count }}
                                        item</span>
                                </div>
                            @else
                                <div style="display: flex; flex-direction: column; align-items: center; gap: 4px;">
                                    <div
                                        style="width: 48px; height: 48px; background: #f4f8fb; border: 1px dashed var(--border-color, #e2e8f0); border-radius: 6px; display: flex; align-items: center; justify-content: center; color: #94a3b8; font-size: 16px;">
                        ...
                        <td style="text-align: center;">
                            <select class="status-dropdown" data-id="{{ $album->id }}" data-table="albums"
                                data-column="status"
                                style="padding: 6px 10px; border-radius: 6px; border: 1px solid #d0e1f0; background: {{ $album->status ? '#ecfdf5' : '#fef2f2' }}; color: {{ $album->status ? '#047857' : '#b91c1c' }}; font-weight: 600; outline: none; cursor: pointer;">
                        ...
                        <td style="text-align: center;">
                            <div class="action-badge">
                                ...
                                <form class="delete-form" action="{{ route('admin.albums.destroy', $album->id) }}"

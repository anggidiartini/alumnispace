                        ...
                        @endphp
                            ...
                            <td style="text-align: center;">
                                <div class="action-badge">
                                    <a href="{{ route('admin.job-vacancies.show', $row->id) }}" class="btn-action btn-detail">
                                        <i class="fa-solid fa-eye"></i> Detail
                                    </a>
                                    <a href="{{ route('admin.job-vacancies.edit', $row->id) }}" class="btn-action btn-edit">
                                        <i class="fa-solid fa-pen-to-square"></i> Edit
                                    </a>
                                    <form class="delete-form" action="{{ route('admin.job-vacancies.destroy', $row->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')

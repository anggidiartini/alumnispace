...
@php
    ...
    $waFallbackUrl =
        ...
        $waFallbackNumber .
        '?text=' .
        urlencode('Halo, saya mau lamar untuk posisi ' . $job->title . ' di ' . $job->company_name);
@endphp
<!doctype html>
<html lang="id">
                ...
                <div class="job-hero grid-paper">
                    ...
                    <div class="job-hero-inner">
                        ...
                        <div class="job-hero-actions">
                            ...
                            @else
                                <a href="{{ $waFallbackUrl }}" target="_blank" rel="noopener"
                                    class="whatsapp-pill-btn">
                                    <span class="whatsapp-pill-icon"><i data-lucide="message-circle" width="15"
                                            height="15"></i></span>
                                    Lamar via WhatsApp
                                </a>
                            @endif
            ...
            <section class="page-width detail-grid">
                ...
                <aside class="company-panel reveal-onscroll">
                    <div class="company-body">
                        ...
                        @else
                            <a href="{{ $waFallbackUrl }}" target="_blank" rel="noopener"
                                class="whatsapp-pill-btn full-width">
                                <span class="whatsapp-pill-icon"><i data-lucide="message-circle" width="15"
                                        height="15"></i></span>
                                Lamar via WhatsApp
                            </a>

@php
    $sidebarIcons = [
        ...
        'galleries' =>
            '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 5.5A2.5 2.5 0 0 1 6.5 3h11A2.5 2.5 0 0 1 20 5.5v13A2.5 2.5 0 0 1 17.5 21h-11A2.5 2.5 0 0 1 4 18.5zm12.5 4.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zM7 15.5l3.2-4.3 2.2 3 2.2-2.7 3.4 4z" fill="currentColor"/></svg>',
        'contents' =>
            '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6 3.5A2.5 2.5 0 0 0 3.5 6v12A2.5 2.5 0 0 0 6 20.5h12A2.5 2.5 0 0 0 20.5 18V6A2.5 2.5 0 0 0 18 3.5zm0 3h12v2H6zm0 4h12v2H6zm0 4h8v2H6z" fill="currentColor"/></svg>',
        'logout' =>
            '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M10 4h8a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-8v-2h8V6h-8zm-1 4.5L4.5 12 9 15.5v-2.5h6V11h-6z" fill="currentColor"/></svg>',
    ];
